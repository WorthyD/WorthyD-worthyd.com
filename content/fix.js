...
const options = {
    ...
    to: (match) => {
       ...
       console.log(items);
        ...
        const descriptionS = description ? description.trimStart() : 'description: ""';
        const datePublishedS = datePublished ? datePublished.trimStart() : 'datePublished: ""';
        const dateModifiedS = dateModified ? dateModified.trimStart() : 'dateModified: ""';
