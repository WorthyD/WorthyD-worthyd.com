    ...
    <>
      ...
      <div className="row callout-3">
        <div className="callout">
          ...
          <h2>Tech Stack</h2>
          <p>
            I've been developing web applications since 2007 and I've had a
            pretty broad tech stack. I currently primarily focus on Angular and
      ...
      <section className="two-col-group">
        <div className="col info no-bg">
          <h2>Gaming</h2>
          <p>
            I game when I can. My habits and tastes have evolved over the years.
            I spend most of my time playing Destiny 2 solo and LEGO games with
            my kids.
          </p>
        </div>
        <div className="col">
